...
if __name__ == '__main__':
  ...
  vtk_initial_volume_view_argument = \
        ...
        '/Users/hshin/workspace/ROI-Engine/src/demo/whole_body_mr_aug2010' + \
        '/roi_n_600/ep2d_diff_386a_WBDWI_IR_B_900.vtk ' + \
  ...
  vtk_initial_volume_view_argument = \
        'vmtkimagereader -ifile ' + \
        '/Users/hshin/workspace/ROI-Engine/src/demo/whole_body_mr_aug2010' + \
        '/roi_n_600/ep2d_diff_386a_WBDWI_IR_B_900_ROIs.vtk ' + \
        '--pipe vmtkimageviewer'
  pypes.PypeRun(vtk_initial_volume_view_argument)
