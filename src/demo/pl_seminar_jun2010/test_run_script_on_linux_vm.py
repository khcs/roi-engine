...
if __name__ == '__main__':
  ...
  while True:
    ...
    if n == 0:
      ...
      # read image
      dicom_path_input = \
                  '/home/hshin/host/hshin/Works/PhD/Dataset/ICR/cvehlow/Liver_Pat3/DICOM/'
      ...
      vtk_initial_volume_view_argument = \
        ...
        '/home/hshin/host/hshin/workspace/ROI-Engine/data/ep2d_diff_b0_750_spair_t_ADC/DICOM'\
      ...
      vtk_ROIn10_volume_view_argument = \
        'vmtkimagereader -f dicom -d ' + \
        '/home/hshin/host/hshin/workspace/ROI-Engine/data/' + \
      ...
      vtk_ROI_view_argument = \
        'vmtkimagereader -f dicom -d ' + \
        '/home/hshin/host/hshin/workspace/ROI-Engine/data/ep2d_diff_b0_750_spair_t_ADC/' +\
        'ROIs/DICOM' + \
        ' --pipe vmtkimageviewer'
      ...
      vtk_ROI_surface_file_name = \
        '/home/hshin/host/hshin/workspace/ROI-Engine/data/ep2d_diff_b0_750_spair_t_ADC/ROIs'+\
